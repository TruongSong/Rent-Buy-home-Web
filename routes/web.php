...
//middleware of user authentication
...
Route::middleware(['auth', 'roles:admin'])->group(function () {
    ...
    Route::controller(PropertyTypeController::class)->group(function () {
        ...
        Route::get('/edit/amenitie/{id}', 'EditAmenitie')->name('edit.amenitis');
...
Route::middleware(['auth', 'roles:agent'])->group(function () {
    ...
    Route::controller(AgentPropertyController::class)->group(function () {
        ...
        Route::get('/agent/update/multiimage/delete/{id}', 'AgentPropertyMultiimageDelete')->name('agent.property.multiimage.delete');
...
//send message from property details pages
...
//send message from agent details pages
