...
<li><a href="{{ route('rent.property') }}">For Rent </li>
<li><a href="{{ route('buy.property') }}">For Buy </li>
               </ul>
               </div>
...
<div class="deals-block-one">
     ...
     <div class="image-box">
          ...
          <div class="buy-btn"><a href="{{ url('property/details/'.$item->id.'/'.$item->property_slug) }}">For {{ $item->property_status }}</a></div>
     </div>
...
@if($item ->agent_id == NULL) 
     ...
     <img src="{{  url('upload/korea.jpg') }}" alt="">
     <span>Admin</span>
     </figure>
     </div>
@else 
...
@endforeach
               ...
               <ul class="pagination clearfix">
                    <li><a href="3" class="current">1</a></li>
                    <li><a href="3">2</a></li>
                    <li><a href="3">3</a></li>
                    <li><a href="3"><i class="fas fa-angle-right"></i></a></li>
               </ul>
               </div>
          </div>
     </div>
