...
@section('title')
{{ $property->property_name }} | Easy Kelvin
@endsection
                    ...
                    <div class="author-info clearfix">
                        <div class="author-box pull-left">
                            ...
                            @if ($property->agent_id == null)
                                <figure class="author-thumb"><img src="{{ url('upload/korea.jpg') }}" alt="">
                                </figure>
                                <h6>Admin</h6>
                            @else
     ...
     <div class="property-sidebar default-sidebar">
          <div class="author-widget sidebar-widget">
               <div class="author-box">
                    ...
                    <figure class="author-thumb"><img src="{{  url('upload/korea.jpg') }}"
                         alt=""></figure>
                    <div class="inner">
                         <h4>Admin</h4>
                         <ul class="info clearfix">
                    ...
                    <figure class="author-thumb"><img src="{{ !empty($property->user->photo) ? url('upload/agent_images/' . $property->user->photo) : url('upload/no_image.jpg') }}"
                         alt=""></figure>
                    <div class="inner">
...
@auth                        </ul>
<div id="app">
<send-message :recevierid="{{ $property->agent_id }}" recevername= "{{ $property->user->name }}">
...
<div class="col-lg-4 col-md-6 col-sm-12 feature-block">
     ...
     <div class="lower-content">
          ...
          <div class="author pull-left">
               ...
               <figure class="author-thumb"><img src="{{  url('upload/korea.jpg') }}" alt=""></figure>
               <h6>Admin</h6>
               @else
