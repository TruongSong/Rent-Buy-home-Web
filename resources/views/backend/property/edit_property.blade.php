                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <a href="https://www.latlong.net/" target="_blank"> Go here to get Latitude
                                                from address</a>
                                        </div>
                                    </div><!-- Col -->
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <a href="https://www.latlong.net/" target="_blank"> Go here to get Longitude
                                                from address</a>
                                        </div>
                                    </div><!-- Col -->
                                </div><!-- Row -->
    ...
    <div class="row">
        ...
        <div class="form-group col-md-4">
            ...
            <select name="facility_name[]" id="facility_name" class="form-control">
                ...
                <option value="SuperMarket" {{ $item->facility_name =='Super Market' ? 'selected' : '' }}>Super Market</option>
