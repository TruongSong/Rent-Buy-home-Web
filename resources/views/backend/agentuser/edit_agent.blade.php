                              ...
                              <input type="hidden" name="id" value="{{ $allagent->id }}">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name"
                                        class="form-control" value="{{ $allagent->name }}">
                                ...
                                <div class="form-group mb-3">
                                   ...
                                   <input type="email" name="email"
                                       class="form-control" value="{{ $allagent->email }}">
                               ...
                               <div class="form-group mb-3">
                                   ...
                                   <input type="text" name="phone"
                                       class="form-control" value="{{ $allagent->phone }}">
                               ...
                               <div class="form-group mb-3">
                                   ...
                                   <input type="text" name="address"
                                       class="form-control" value="{{ $allagent->address }}">
